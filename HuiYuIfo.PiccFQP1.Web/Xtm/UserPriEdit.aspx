<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserPriEdit.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Xtm.UserPriEdit" %>
...
<body>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            $.getJSON("../Index/AjaxPage.aspx?optype=departJson&id=" + $("#Did").val(), function (data) {
        ...
        function saveajax(menustr) {
            $.post("../Index/AjaxPage.aspx?optype=savedepart", menustr,
          function (data) {
              if (data == "y") {
                  alert("保存完成");
                  window.close();
