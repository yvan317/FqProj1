<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TxjsList.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Yw.TxjsList" %>
...
<body>
	<form id="form1" runat="server">
		<asp:Panel ID="panCom" CssClass="panCom" runat="server">
			<table width="99%">
				<tr>
					<td align="left" width="50%"><span class="navTitle">推修系数管理</span></td> 
		...
		<asp:Panel ID="panQry" runat="server">
			<table class="tableQry">
				<tr>
                    <td align="left"><img src="../Content/Img/grip.gif" alt="grip"/>推修码</td>
					<td align="left"><asp:TextBox ID="Txm" runat="server" CssClass="input"></asp:TextBox></td>
		...
		<asp:Panel ID="panList" runat="server">
			<asp:GridView ID="list"  CssClass="list" runat="server" AutoGenerateColumns="false" OnRowCommand="GridView_RowCommand">
				<Columns>
					<asp:BoundField DataField="Txm" HeaderText="推修码" />
                    <asp:BoundField DataField="Xlc" HeaderText="修理厂" />
                    <asp:BoundField DataField="Zy" HeaderText="有无专员" />
                    <asp:BoundField DataField="Xs" HeaderText="推修系数值" />
