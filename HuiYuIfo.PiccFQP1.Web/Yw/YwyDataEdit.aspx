<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YwyDataEdit.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Yw.YwyDataEdit" %>
	...
	<form id="form1" runat="server">
			...
			<table width="99%">
				<tr>
					...
					<td align="right" width="50%"> 
                        <asp:LinkButton ID="butClearAtt" CommandName="clearAllAtt" runat="server" CssClass="combut" Text="清空附件" OnClick="Button_Click"><img src="../Content/Img/delete.gif" alt="save"/>清空附件</asp:LinkButton>
						...
						|<asp:LinkButton ID="butSave" CommandName="ywySave" runat="server" CssClass="combut" Text="保存" OnClick="Button_Click"><img src="../Content/Img/save.png" alt="save"/>保存</asp:LinkButton>
                        |<asp:LinkButton ID="butSubmit" CommandName="ywySubmit" runat="server" CssClass="combut" Text="提交" OnClick="Button_Click"><img src="../Content/Img/save.png" alt="save"/>提交</asp:LinkButton>
		...
		<asp:Panel ID="panCon" CssClass="panCon" runat="server">
            ...
            <table class="tableCon"  cellspacing="0">
                ...
                <tr>
                    <td style="text-align:left;border-right:none;" colspan="6">
                        <input type="file" name="uploadify" id="uploadify" />
                    </td>
                </tr>
            </table>

			<table class="tableCon"  cellspacing="0" style="margin-top:20px;">
				...
				<tr>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:TextBox ID="Cxcs" runat="server" CssClass="input"   ReadOnly="true"/>
					</td>

                    <td style="text-align:left;border-right:none;">上年承保公司</td>
					<td style="text-align:left;border-left:none;">
                        <asp:TextBox ID="Sncbgs" runat="server" CssClass="input"   ReadOnly="true"/>
					</td>
                </tr>
                ...
                <tr>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:DropDownList ID="Sfpa" runat="server" CssClass="input" Enabled="false">
                            <asp:ListItem Value="否" Text="否"></asp:ListItem>
                            <asp:ListItem Value="是" Text="是"></asp:ListItem>
                        </asp:DropDownList>
					</td>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:DropDownList ID="Sfyz" runat="server" CssClass="input" Enabled="false">
                            <asp:ListItem Value="否" Text="否"></asp:ListItem>
                            <asp:ListItem Value="是" Text="是"></asp:ListItem>
                        </asp:DropDownList>
					</td>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:DropDownList ID="Cx2c" runat="server" CssClass="input" Enabled="false">
                            <asp:ListItem Value="否" Text="否"></asp:ListItem>
                            <asp:ListItem Value="是" Text="是"></asp:ListItem>
                        </asp:DropDownList>
					</td>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:DropDownList ID="Sfcgb" runat="server" CssClass="input" Enabled="false">
                            <asp:ListItem Value="否" Text="否"></asp:ListItem>
                            <asp:ListItem Value="是" Text="是"></asp:ListItem>
                        </asp:DropDownList>
					</td>
                ...
                <tr>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:TextBox ID="Tslx" runat="server" CssClass="input"  ReadOnly="true"/>
					</td>

                   <td style="text-align:left;border-right:none;">出险3次，是否赔付200%</td>
					<td style="text-align:left;border-left:none;">
                        <asp:DropDownList ID="Cx3c" runat="server" CssClass="input" Enabled="false">
                            <asp:ListItem Value="否" Text="否"></asp:ListItem>
                            <asp:ListItem Value="是" Text="是"></asp:ListItem>
                        </asp:DropDownList>
					</td>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:DropDownList ID="Wfglcx" runat="server" CssClass="input" Enabled="false">
                            <asp:ListItem Value="否" Text="否"></asp:ListItem>
                            <asp:ListItem Value="是" Text="是"></asp:ListItem>
                        </asp:DropDownList>
					</td>
                ...
                <tr>
					...
					<td style="text-align: left; border-left: none;" colspan="7">
						<asp:TextBox ID="Bz" runat="server" CssClass="input" Width="500px" ReadOnly="true"/>
					</td>
				</tr>
                ...
                <tr>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:TextBox ID="Qd" runat="server" CssClass="input" ReadOnly="true"/>
					</td>
                ...
                <tr>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:TextBox ID="Dzh" runat="server" CssClass="input" ReadOnly="true"/>
					</td>
    ...
    $(document).ready(function () {
        $("#uploadify").uploadify({
            ...
            'onUploadStart': function (file) {
                var temp=$("#Did").val();
                $("#uploadify").uploadify("settings", "formData",{'id':temp});
            }
