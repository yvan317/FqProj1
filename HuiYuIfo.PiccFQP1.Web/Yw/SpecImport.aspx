<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecImport.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Yw.SpecImport" %>
...
<body>
	<form id="form1" runat="server">
		<asp:Panel ID="panCom" CssClass="panCom" runat="server" enctype="multipart/form-data">
			<table width="99%">
				<tr>
					<td align="left" width="50%"><span class="navTitle">导入特殊情况</span></td> 
			...
			<table class="tableCon"  cellspacing="0">
				<tr>
					<td style="text-align:left;border-left:none;">
                        <asp:FileUpload ID="specFile" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:LinkButton ID="butImport" CommandName="importSave" runat="server" CssClass="combut" Text="上传" OnClick="Button_Click">上传</asp:LinkButton></td>
                </tr>
			</table>
		</asp:Panel>
	</form>
