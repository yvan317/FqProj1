<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CbComfirmEdit.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Yw.CbComfirmEdit" %>
	...
	<form id="form1" runat="server">
			...
			<table width="99%">
				<tr>
					...
					<td align="right" width="50%"> 
						...
						|<asp:LinkButton ID="butSave" CommandName="cbComfirm" runat="server" CssClass="combut" Text="审核通过" OnClick="Button_Click"><img src="../Content/Img/save.png" alt="save"/>审核通过</asp:LinkButton>
                        |<asp:LinkButton ID="LinkButton1" CommandName="cbUnComfirm" runat="server" CssClass="combut" Text="审核不通过" OnClick="Button_Click"><img src="../Content/Img/save.png" alt="save"/>审核不通过</asp:LinkButton>
		...
		<asp:Panel ID="panCon" CssClass="panCon" runat="server">
            ...
            <table class="tableCon"  cellspacing="0">
                ...
                <tr><td colspan="8" style="color:Red;font-size:14px;font-weight:bold">业务员填写</td></tr>
                <tr>
