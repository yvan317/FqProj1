<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChargeImport.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Yw.ChargeImport" %>
...
<body>
	<form id="form1" runat="server">
		<asp:Panel ID="panCom" CssClass="panCom" runat="server" enctype="multipart/form-data">
			<table width="99%">
				<tr>
					<td align="left" width="50%"><span class="navTitle">导入差异化数据</span></td> 
