<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YwyQueryList.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Report.YwyQueryList" %>
<%@ Register Assembly="HuiYuIfo.Framework.Web" Namespace="HuiYuIfo.Framework.Web" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>业务员手续费查询</title>
...
<body>
	<form id="form1" runat="server">
		<asp:Panel ID="panCom" CssClass="panCom" runat="server">
			<table width="99%">
				<tr>
					<td align="left" width="50%"><span class="navTitle">业务员手续费查询</span></td> 
					<td align="right" width="50%"> 
                        <asp:LinkButton ID="butExport" CommandName="ywyQueryExport" runat="server" CssClass="combut" Text="导出最后结账数据" OnClick="Button_Click"><img src="../Content/Img/export.png" alt="create"/>导出最后结账数据</asp:LinkButton>
					</td> 
				</tr>
			</table>
		</asp:Panel>
