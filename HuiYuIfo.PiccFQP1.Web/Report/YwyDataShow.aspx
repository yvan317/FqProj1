<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YwyDataShow.aspx.cs" Inherits="HuiYuIfo.PiccFQP1.Web.Report.YwyDataShow" %>
            ...
            <table class="tableCon"  cellspacing="0">
               ...
               <tr><td colspan="8" style="color:Red;font-size:14px;font-weight:bold">承保、财务意见</td></tr>
				...
				<tr>
					...
					<td style="text-align:left;border-left:none;">
                        <asp:TextBox ID="DepartName" runat="server" CssClass="input"   ReadOnly="true"/>
					</td>
